...
АСССЗ должна реализовывать возможность дальнейшей модернизации программного обеспечения и возможности в будущем добавлять дополнительные поля для выгрузки.
