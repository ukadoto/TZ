...
– Заявка от 15.09.2019 номер SD-7598 
...
- Реграментом подразделения Разработчика;
- внутренними правилами Компании в отношении разработки и документации ПО.
...
Основными целями создания АИС  АСССЗ:
...
Сотруднику необходимо вручную запускать АРМ, просматривать поступившие сервисные заявки и сортировать их исходя из текста сервисной заявки на различные тематические категории. После чего сотрудник формирует выборку исходя из категории сервисной заявки и отдает их исполнителю для проработки. На это тратится много ресурса, так как прочитать и проанализировать все сервисные заявки сотруднику приходится в ручном режиме, так же высока вероятность ошибки в связи с человеческим фактором, так как к концу дня становится трудно анализировать текст из-за однотипности работы. 
АСССЗ должна освободить сотрудника от выполнения рутиной работы, а так же в автоматическом режиме сортировать заявки и формировать отчетность о количестве заявок исходя из заданных критериев.


4 ТРЕБОВАНИЯ К СИСТЕМЕ
4.1.1 Требования к структуре и функционированию системы
Систеема должна быть совместима с текущим ПО, используемым в работе Компании. Предполагается разработка отдельного инструмента в рамках АРМ, позволяющего автоматизировать деятельность сотрудника подразделения. Вся информация, кроме критериев сортировки, должна подгружаться автоматически, без участия сотрудника.

4.1.1.1 Перечень подсистем, их назначение и основные характеристики
Перечень подсистем, необходимыз для реализации  должны быть уточнены на стадии подготовки и проектирования ПО.
...
Аварийный режим функционирования системы характеризуется отказом одного или нескольких компонент программного и (или) технического обеспечения в следствии указания сотрудником некорректных данных для выгрузки либо сбоя в работе смежных систем.
...
В случае непредвиденных сбоев система должна сохранять работоспособность и обеспечивать восстановление своих функций в случае перезагрузки инструмента выгрузки.
...
Состав и содержание работ по проектированию, разработке и тестированию АСССЗ формируется Исполнителем и утверждается с представителем Заказчика. 
...
Для введения в эксплуатацию системы сортировки заявок Исполнитель должен обеспечить выполнение следующих работ:
- Определить подразделение и ответственных должностных лиц, ответственных за внедрение и проведение опытной эксплуатации АСССЗ;
- Обеспечить выполнение требований, предъявляемых к программно-техническим средствам, на которых должно быть развернуто программное обеспечение АСССЗ.

Для введения в эксплуатацию системы сортировки заявок Заказчик должен обеспечить выполнение следующих работ:
...
- Провести опытную эксплуатацию АСССЗ.
...
Для система автоматической сортировки заявок должна быть составлена инструкция на русском языке, обязательно включающая в себя:
- описание функционала отдельных кнопок и интерфейсов;
- описание возможных аварийных ситуаций и ошибок, возникающих в ходе эксплуатации;
- расшифровка кодов ошибок и рекомендации по их устранению.
